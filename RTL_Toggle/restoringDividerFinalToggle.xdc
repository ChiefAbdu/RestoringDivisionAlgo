...
set_property -dict { PACKAGE_PIN U11   IOSTANDARD LVCMOS33 } [get_ports { user_input[14] }];
set_property -dict { PACKAGE_PIN V10   IOSTANDARD LVCMOS33 } [get_ports { user_input[15] }]; #MSB
...
# Toggle Button
set_property -dict { PACKAGE_PIN M18   IOSTANDARD LVCMOS33 } [get_ports { toggle_input }]; # Upper  Button on FGPA

# Push Button
set_property -dict { PACKAGE_PIN P17   IOSTANDARD LVCMOS33 } [get_ports { push }]; # Left  Button on FGPA

# Start Button
set_property -dict { PACKAGE_PIN M17   IOSTANDARD LVCMOS33 } [get_ports { start }]; # Right  Button on FGPA

# Toggle Remainder Quotient
set_property -dict { PACKAGE_PIN N17   IOSTANDARD LVCMOS33 } [get_ports { toggle_rq }]
...
# Toggle 1 Signal
set_property -dict { PACKAGE_PIN V17   IOSTANDARD LVCMOS33 } [get_ports { toggle_led }];

# Toggle RQ 1 Signal
set_property -dict { PACKAGE_PIN V16   IOSTANDARD LVCMOS33 } [get_ports { toggle_rq_led }];
